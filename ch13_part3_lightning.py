...
work_path="d:\\Research\\ResearchMethods\\Python-Book-Package\\Raschka-MachineLearningPyTorchScikitLearn-2022-Point45\\machine-learning-book-main\\ch13"
...
class MultiLayerPerceptron(pl.LightningModule):
    def __init__(self, image_shape=(1, 28, 28), hidden_units=(32, 16)):
        ...
        #following three lines added by Wilson
...
#new version, according to following links
#https://github.com/rasbt/machine-learning-book/discussions/124
...
if torch.cuda.is_available(): # if you have GPUs
    ...
    #following line added by Wilson
...
if torch.cuda.is_available(): # if you have GPUs
    ...
    trainer = pl.Trainer(
        max_epochs=25, callbacks=callbacks, resume_from_checkpoint=path
    )
