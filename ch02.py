...
work_path="d:\\Research\\ResearchMethods\\Python-Book-Package\\Raschka-MachineLearningPyTorchScikitLearn-2022-Point45\\machine-learning-book-main\\ch02"
...
#If data not available on internet,read it locally
#df = pd.read_csv(
