...
work_path="d:\\Research\\ResearchMethods\\Python-Book-Package\\Raschka-MachineLearningPyTorchScikitLearn-2022-Point45\\machine-learning-book-main\\ch08"
...
#seems above not work properly
#so manually extract tar file in local directory
...
#Wilson changed some code because append deprecated
for s in ('test', 'train'):
    for l in ('pos', 'neg'):
...
#Above job to save to a csv file in local directory.
...
#if you encounter the NoneType error, you have to start
