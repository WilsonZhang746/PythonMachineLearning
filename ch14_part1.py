...
work_path="d:\\Research\\ResearchMethods\\Python-Book-Package\\Raschka-MachineLearningPyTorchScikitLearn-2022-Point45\\machine-learning-book-main\\ch14"
...
import os
#to avoid restarting kernel when using matplotlib
#added by Wilson
